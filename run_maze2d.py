...
def main():
    ...
    parser.add_argument('--task', type=str, default='maze2d')
    parser.add_argument('--ds', type=str, default='large-dense')
    parser.add_argument('--algo', type=str, default='ucb-vae')
    parser.add_argument('--seed', type=int, default=100)
    parser.add_argument('--log-dir', type=str, default='logs')
    parser.add_argument('--model-path',type=str,default="models")
    parser.add_argument('--save', type=bool, default=False)#是否保存模型
    ...
    parser.add_argument('--vae-mask', default=True, action="store_true")
    ...
    """
    base_dir = os.getcwd()
    configs_path = os.path.join(base_dir,"configs",args.task,args.ds+".yaml")
